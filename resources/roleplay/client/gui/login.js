...
function initLoginGUI() {
    console.log(`[VRR.GUI] Creating login GUI ...`);
	...
	console.log(`[VRR.GUI] Created login GUI`);
}
...
function showLoginGUI() {
	closeAllWindows();
	console.log(`[VRR.GUI] Showing login window`);
...
function checkLogin() {
	console.log(`[VRR.GUI] Checking login with server ...`);
...
function loginFailed(errorMessage) {
	console.log(`[VRR.GUI] Server reports login failed`);
...
function loginSuccess() {
	console.log(`[VRR.GUI] Server reports login was successful`);
	guiSubmitKey = false;
	closeAllWindows();
}
...
function switchToPasswordResetGUI() {
	closeAllWindows();
	console.log(`[VRR.GUI] Showing password reset dialog window`);
