...
addNetworkHandler("updateMoney", function(newMoney) {
    game.hud.setMoney(newMoney);
});

addEventHandler("OnMapLoaded", function(event, client, mapNew) {
    let mapNew = game.mapName;
    triggerNetworkEvent("mapLoaded", mapNew);
  });